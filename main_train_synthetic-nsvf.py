...
#parser.add_argument("-config", type=str, default="configs/mip_nerf.yml", help="Path to config file")
...
timestamp = timestamp+'_synthetic-nsvf'
...
if __name__ == "__main__":
  ...
  for scene_to_train in scenes:
    ...
    config.scene.source_path = "./dataset/Synthetic_NSVF/" + scene_to_train
    config.training.densify_grad_threshold = 0.00005
