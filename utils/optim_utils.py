...
def define_optimizer_manager(config_opti,pointcloud,lr_list_pos,lr_list_rgb,lr_list_sh,lr_list_density,
  ...
  log_phase(logger, "Optimizer Initialization")
  ...
  if config_pos.scheduler:
    logger.info("ExponentialLR for positions")
    ...
    logger.info("ConstantLR for positions")
  ...
  if config_rgb.scheduler:
    logger.info("ExponentialLR for RGB")
    ...
    logger.info("ConstantLR for RGB")
  ...
  if config_sh.scheduler:
    logger.info("ExponentialLR for spherical harmonics")
    ...
    logger.info("ConstantLR for spherical harmonics")
  ...
  if config_density.scheduler:
    logger.info("ExponentialLR for densities")
    ...
    logger.info("ConstantLR for densities")
  ...
  if config_scale.scheduler:
    logger.info("ExponentialLR for scales")
    ...
    logger.info("ConstantLR for scales")
  ...
  if config_quaternion.scheduler:
    logger.info("ExponentialLR for quaternions")
    ...
    logger.info("ConstantLR for quaternions")
  ...
  if config_sph_gauss_features.scheduler:
    logger.info("ExponentialLR for spherical gaussian features")
    ...
    logger.info("ConstantLR for spherical gaussian features")
  ...
  if config_bandwidth_sharpness.scheduler:
    logger.info("ExponentialLR for bandwidth sharpness")
    ...
    logger.info("ConstantLR for bandwidth sharpness")
  ...
  if config_lobe_axis.scheduler:
    logger.info("ExponentialLR for lobe axis")
    ...
    logger.info("ConstantLR for lobe axis")
