...
if gui_mode: #Case where we have an output file
    ...
    # pointcloud.densities=pointcloud.densities/100.0
    # pointcloud.subsample(0.5)
else:
...
if __name__ == '__main__':
    ...
    init_main_params(state.params,max_prim_slice=max_prim_slice,degree_sh=degree_sh,max_sh_degree=degree_sh,
                     ...
                     densities=cp_densities,color_features=cp_color_features,sph_gauss_features=cp_sph_gauss_features,
                        ...
                        quaternions=cp_quaternions,width=width,height=height,
    ...
    if gui_mode:
        ...
        init_camera_state(state,eye=state.barycenter-(6,6,6),look_at=state.barycenter)
        ############################################################################################################
    ...
    state.program_grps=u_ox.create_program_groups(state.ctx,state.module)
